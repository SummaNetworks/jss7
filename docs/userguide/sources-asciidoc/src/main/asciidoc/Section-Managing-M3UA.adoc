...
Open a Web Browser and navigate to http://localhost:8080/jss7-management-console/. Click on the 'M3UA' link in the left panel.
...
On M3UA management page, click on pencil against the 'Worker Threads' property and text box becomes editable.
...
In the M3UA management page, you can view the current settings of the 'MTP3 RoutingLabel Format' property.
But as explained above, you cannot change the settings in the GUI.
For more details about this parameter, refer to the detailed description about the parameter in the above section for CLI.
