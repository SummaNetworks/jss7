...
*
*/
public class NoteMsPresentForGprsRequestTest {
    ...
    private byte[] getAddressData2() {
        return new byte[] { (byte) 92, (byte) 18, 4, 22 };
    }
...
/*    @Test(groups = { "functional.decode", "service.pdpContextActivation" })
    public void testDecode() throws Exception {
        ...
        NoteMsPresentForGprsRequestImpl impl = new NoteMsPresentForGprsRequestImpl();
        impl.decodeAll(asn);
        ...
        impl = new NoteMsPresentForGprsRequestImpl();
        impl.decodeAll(asn);
    ...
    public void testEncode() throws Exception {
        ...
        NoteMsPresentForGprsRequestImpl impl = new NoteMsPresentForGprsRequestImpl(imsi, null, ggsnNumber, null);
        ...
        impl = new NoteMsPresentForGprsRequestImpl(imsi, ggsnAddress, ggsnNumber, MAPExtensionContainerTest.GetTestExtensionContainer());
    ...
    public void testEncodeDecode() throws Exception {
        ...
        NoteMsPresentForGprsRequestImpl impl = new NoteMsPresentForGprsRequestImpl(imsi, sgsnAddress, null, null);

        AsnOutputStream asnOS = new AsnOutputStream();

        impl.encodeAll(asnOS);

        byte[] rawData = asnOS.toByteArray();
        ...
        assertEquals(impl.getImsi().getData(), "1111122222333");
        assertNull(impl.getGgsnAddress());
        assertNotNull(impl.getSgsnAddress());
        assertEquals(impl.getSgsnAddress().getGSNAddressData(), getAddressData());
        assertNull(impl.getExtensionContainer());


        impl = new NoteMsPresentForGprsRequestImpl(imsi, sgsnAddress, ggsnAddress, MAPExtensionContainerTest.GetTestExtensionContainer());

        asnOS = new AsnOutputStream();
        impl.encodeAll(asnOS);

        rawData = asnOS.toByteArray();
        ...
        assertEquals(impl.getImsi().getData(), "1111122222333");
        assertNotNull(impl.getGgsnAddress());
        assertNotNull(impl.getSgsnAddress());
        assertEquals(impl.getSgsnAddress().getGSNAddressData(), getAddressData());
