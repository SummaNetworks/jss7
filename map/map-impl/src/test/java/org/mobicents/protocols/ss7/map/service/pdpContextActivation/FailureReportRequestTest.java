...
public class FailureReportRequestTest {
    ...
    public void testEncode() throws Exception {
        ...
        FailureReportRequestImpl impl = new FailureReportRequestImpl(imsi, null, ggsnNumber, null);
        ...
        impl = new FailureReportRequestImpl(imsi, ggsnAddress, ggsnNumber, MAPExtensionContainerTest.GetTestExtensionContainer());
