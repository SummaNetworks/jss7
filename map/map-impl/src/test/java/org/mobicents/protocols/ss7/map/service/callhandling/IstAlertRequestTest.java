 ...
 *
 */
public class IstAlertRequestTest {
    Logger logger = LogManager.getLogger(IstAlertRequestTest.class);
    ...
    public void testDecode() throws Exception {
        ...
        IstAlertRequestImpl prim = new IstAlertRequestImpl();
        prim.decodeAll(asn);
    ...
    public void testEncode() throws Exception {
        ...
        IstAlertRequestImpl prim = new IstAlertRequestImpl(imsi, extensionContainer);
