 ...
 * @author eva ogallar
 */
public class ModificationRequestForECTInfoImpl extends AbstractMAPAsnPrimitive implements ModificationRequestForECTInfo {
    ...
    public static final String PRIMITIVE_NAME = "ModificationRequestForECTInfo";

    public ModificationRequestForECTInfoImpl() {
    }

    public ModificationRequestForECTInfoImpl(ExtSSStatus ssStatus, ModificationInstruction modifyNotificationToCSE, MAPExtensionContainer extensionContainer) {
