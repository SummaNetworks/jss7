 ...
 * @author eva ogallar
 */
public class EctDataImpl extends AbstractMAPAsnPrimitive implements EctData, MAPAsnPrimitive {

    public static final String _PrimitiveName = "EctData";
    ...
    public EctDataImpl(boolean notificationToCSE, ExtSSStatus ssStatus) {
