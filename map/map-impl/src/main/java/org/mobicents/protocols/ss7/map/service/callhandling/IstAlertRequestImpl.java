 ...
 *
 */
public class IstAlertRequestImpl extends CallHandlingMessageImpl implements IstAlertRequest {

    public static final String _PrimitiveName = "IstAlertRequest";
    ...
    public IstAlertRequestImpl(IMSI imsi, MAPExtensionContainer extensionContainer) {
        this.imsi = imsi;
        this.extensionContainer = extensionContainer;
    }

    public IstAlertRequestImpl() {
    }
    ...
    public MAPMessageType getMessageType() {
        return MAPMessageType.istAlert_Request;
    }
